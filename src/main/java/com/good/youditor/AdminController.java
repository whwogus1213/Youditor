...
public class AdminController {
	...
	public String adminAccount(@RequestParam("accountId") int accountId, Model model, HttpSession session) throws Exception {
		String result = "";
		if (session.getAttribute("loginAdmin") != null) {
			model.addAttribute("AccountInfo", service.getAccountInfo(accountId));
			result = "admin/adminAccount";
		} else {
			result = "redirect:/";
		}
	...
	public String adminCategory(@RequestParam("category") String category, Model model, HttpSession session) throws Exception {
		String result = "";
		if (session.getAttribute("loginAdmin") != null) {
	...
	public String accountUpdate(HttpSession session,
		...
		if (session.getAttribute("loginAdmin") != null) {
			...
			result = "redirect:/adminAccount?accountId=" + accountId;
		} else {
			result = "redirect:/";
		}
		return result;
	...
	@ResponseBody
	public int adminMoveCatPro(HttpSession session,
	...
	@ResponseBody
	public int adminDelCatPro(HttpSession session,
							@RequestParam("category") String category,
							@RequestParam("categoryId") int categoryId,
							@RequestParam("moveTo") int moveTo) throws Exception {
		int result = 0;
	...
	@ResponseBody
	public int adminEditCatPro(HttpSession session,
								@RequestParam("category") String category,
								@RequestParam("categoryId") int categoryId,
	...
	@ResponseBody
	public int adminNewCatPicPro(HttpSession session,
								@RequestParam("categoryId") int categoryId,
	...
	@ResponseBody
	public int adminAddCatPro(HttpSession session,
