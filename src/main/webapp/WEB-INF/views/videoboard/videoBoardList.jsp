...
<body>
	<script>
		...
		//페이지 번호 클릭
		function fn_pagination(page, range, rangeSize, categoryId, searchType,
				keyword) {
			var url = "${pageContext.request.contextPath}/videoboard/videoBoardList";
	...
	<div class="form-group">
		...
		<h5 align="center"><%=request.getAttribute("categoryName")%>
			유투버들의 편집 영상입니다.
		</h5>
					...
					<div class="card h-100" style="display: block">
						...
						<div class="card-body" align="center">
							<script>
								...
								//document.write('<p>' + youtubeID + '</p>');
								document
										.write('<img width="300" height="200" src="https://img.youtube.com/vi/' + youtubeID + '/mqdefault.jpg"></img>');
							</script>
						</div>
						<div class="card-footer" align="left">
							<div class="row">
								...
								<div class="col-sm-6" align="right">
									<img
										src="<spring:url value='/image/${VideoBoardList.picture}'/>"
										class=" mx-auto rounded-circle" width="20px" height="20px" />&nbsp;${VideoBoardList.nickname}<br>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6" align="left">
							...
							<div class="row">
								...
								<div class="col-sm-6" align="right">
									${VideoBoardList.starCount} / 5.0</div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-sm-3" align="center">
				<c:if test="${login.email != null}">
					<button type="button" class="btn btn-primary"
						onclick="location.href='/videoboard/write.do' ">유투브 올리기</button>
				</c:if>
			</div>
		</div>
		<!-- 검색 -->
